	...
	<div class="one_comment">
		...
		<div>
			<form name="modify_comment_form" method="POST">
				<p>수정박스입니다.</p>
				<input type="hidden" name="id" value="${commentVo.id}" /> <input
					type="text" name="nickname" value="${commentVo.nickname}"
					placeholder="닉네임" /><br /> <input type="text" name="content"
					value="${commentVo.content}" placeholder="댓글을 입력해주세요." /> <input
