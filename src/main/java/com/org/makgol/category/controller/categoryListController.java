...
public class CategoryListController {
	...
	public void rouletteResult(@RequestParam("category") String category, Model model) {
		switch (category) {
		case "한식":
			List<CategoryListVo> categoryVoKor = categoryListService.categoryKor();
			break;
		case "양식":
			List<CategoryListVo> categoryVoWest = categoryListService.categoryWest();
			break;
		case "중식":
			List<CategoryListVo> categoryVoChi = categoryListService.categoryChi();
			break;
		case "분식":
			List<CategoryListVo> categoryVoSnack = categoryListService.categorySnack();
			break;
		case "일식":
			List<CategoryListVo> categoryVoJpn = categoryListService.categoryJpn();
			break;
		case "카페":
			List<CategoryListVo> categoryVoCafe = categoryListService.categoryCafe();
			break;
		}
